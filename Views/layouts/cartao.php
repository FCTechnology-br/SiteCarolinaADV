...
<head>
    ...
    <style>
        :root {
            ...
            /* Azul Noturno */
            --bg-page: #f4f5f7;
            /* Fundo da tela claro e premium */
            --bg-card: #ffffff;
            /* Cartão branco puro */
            --text-dark: #1e293b;
            /* Cinza/Azul muito escuro para títulos */
            --text-light: #64748b;
            /* Cinza suave para descrição */
        ...
        * {
        ...
        .digital-card-container {
            ...
            border-radius: 24px;
            padding: 40px 25px;
            box-shadow: 0 20px 50px rgba(23, 42, 68, 0.08);
            /* Sombra super orgânica azulada */
            text-align: center;
            position: relative;
            overflow: hidden;
...
<body>
    ...
    <div class="digital-card-container">
        ...
        <div class="links-container">
            ...
            <a href="https://maps.google.com?q=Avenida+dos+Autonomistas,+2435+-+Centro+-+Osasco" target="_blank"
                class="link-btn">
            ...
            <div class="address-display">
                <p>Av. dos Autonomistas, 2435 - Conj 203A<br>
                    ...
                    <small>Estacionamento no local</small>
                </p>
            </div>
